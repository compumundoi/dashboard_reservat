...
import { Search, X, Eye, Edit, Trash2, MapPin, Clock, Star, Users, Calendar, ChevronLeft, ChevronRight, Utensils, Package } from 'lucide-react';
                ...
                <TableCell className="text-right">
                  <div className="flex items-center justify-end gap-1">
                    ...
                    <Button
                      ...
                      onClick={() => setProveedorServicios({ id: restaurante.id_restaurante, nombre: restaurante.nombre || '' })}
                    >
