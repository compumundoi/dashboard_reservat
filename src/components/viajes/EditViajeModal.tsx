...
const EditViajeModal: React.FC<EditViajeModalProps> = ({ isOpen, onClose, onSave, viaje }) => {
  ...
  useEffect(() => {
    if (viaje && isOpen) {
      ...
      setFormData({
        ...
        estado: (viaje.estado as any) || ESTADOS_VIAJE.PROGRAMADO,
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      title="Editar Viaje"
      description={`Actualizar información del viaje ${viaje?.id?.slice(0, 8)}...`}
      size="2xl"
    >
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-xl border border-gray-200">
            ...
            />
            <label htmlFor="edit-activo" className="text-sm font-medium text-gray-700 flex items-center gap-2">
